...
describe('CaseAssociates', function () {
    it('Should display case associates ', function () {
        var owner= {
            "resource": {
                "fullName": "Test User",
                    "email": [
        ...
        assert.ok(instance.getDOMNode().children[0].children[0].innerText.match("Support Associates"));
